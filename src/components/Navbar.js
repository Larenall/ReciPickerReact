...
class Navbar extends Component {
  ...
  render() {
    return (
      <nav>
        <div id="navbar">
          <div id="mainLogo">ReciPicker</div>
          <button
            className="nav-btn"
            onClick={() => {
        ...
        >
          ...
          <div className="dropdown-menu">
            <div className="dropdown-item" onClick={this.GoToUsersRecipes}>My recipes</div>
            <div className="dropdown-item" onClick={this.GoToUsersRecipes}>Favourite recipes</div>
